    ...
    try {
      ...
      switch(call_type) {
        ...
        case "POST": {
          ...
          //response = reqSpec.body(body).post(call_string);
          //String str = reqSpec.body(body).post(call_string).asString();
          //System.out.print(body);
          //parameters("password","d6fd6e551699e286e3a4c6c66874f8e9","authcode","9999","clientId","C6C1E05E5D300001576756F31C081A21")
          break;
        }
        case "PUT": {
